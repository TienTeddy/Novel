...
namespace Novel.DAL.Migrations
{
    ...
    [Migration("20210812042015_create_qrcode")]
    partial class create_qrcode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Novel.DAL.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7b64f5f8-125b-4954-bdb3-a18fd2e026da",
            ...
            modelBuilder.Entity("Novel.DAL.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2609194d-d512-4655-aa81-15f1bf760fb6",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHMO0lCSY1DKWI/xUVHTynpnYEIweMHd/8LfVbxBws0l/zRvAPidIoK0iriu8wTmEA==",
            ...
            modelBuilder.Entity("Novel.DAL.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id_product = 1,
                            date_created = new DateTime(2021, 8, 12, 11, 20, 13, 720, DateTimeKind.Local).AddTicks(4962),
            ...
            modelBuilder.Entity("Novel.DAL.Entities.QrCodeUser", b =>
                {
                    b.Property<int>("id_qrcode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:IdentityIncrement", 1)
                        .HasAnnotation("SqlServer:IdentitySeed", 1)
            ...
            modelBuilder.Entity("Novel.DAL.Entities.QrCodeUser", b =>
                {
                    b.HasOne("Novel.DAL.Entities.AppUser", "AppUser")
                        .WithOne("QrCodeUser")
                        .HasForeignKey("Novel.DAL.Entities.QrCodeUser", "id_user")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
